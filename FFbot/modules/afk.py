...
from FFbot.modules.disable import DisableAbleCommandHandler, DisableAbleRegexHandler
...
def reply_afk(bot: Bot, update: Update):
    ...
    if message.entities and message.parse_entities([MessageEntity.TEXT_MENTION, MessageEntity.MENTION]):
        ...
        for ent in entities:
            ...
            check_afk(update, user_id, fst_name)
...
def check_afk(update, user_id, fst_name):
